...
const Jeu = (function () {
  ...
  function commencer() {
    ...
    B.mission = null; B.defi = null; B.epreuve = null; B.conduite = null; B.rue = null; B.cinema = null; B.ouverture = null; B.scene = null; B.finEnAttente = null; B.generiqueEnAttente = null; B.videopoker = null; B.orignal = null;
  ...
  function demarrer(w, d) {
    ...
    return chargerDefinitions(racine).then(function (defs) {
      ...
      Defi.init(w, racine);
      // CE QU'UNE MISSION DEMANDE POUR SE JOUER (24 sept. 2026) : hors du paquet, une
