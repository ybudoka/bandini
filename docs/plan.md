...
| ce qui est **livré** (248 jalons) | [jalons/README.md](jalons/README.md) |
...
| Le dojo du quartier : apprendre les techniques | ⬜ **en cours** | 26 sept. 2026 | **P4** | ajout | [fiche](jalons/le-dojo-du-quartier.md#fiche) |
| Le quartier chinois : le Petit-Canton, un 7e district | ⬜ **à faire** | — | **P3** | ajout | [fiche](jalons/le-quartier-chinois.md#fiche) |
...
| Quatre activités que le jeu n'a pas | ⬜ **en cours** (livrés : les paliers de boulot, le pompier volontaire, la patrouille, la liste du quai ; restent les frénésies, à trancher par Martin) | 15 sept. 2026 | **P4** | ajout | [fiche](jalons/quatre-activites-que-le-jeu-n-a-pas.md#fiche) · [notes](jalons/quatre-activites-que-le-jeu-n-a-pas.md#notes) |
...
| Le derby de démolition à la foire | ⬜ **en cours** | 26 sept. 2026 | **P4** | ajout | [fiche](jalons/le-derby-de-demolition-a-la-foire.md#fiche) |
