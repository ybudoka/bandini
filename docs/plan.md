...
| M11 La police apprend | **1re vague en cours** (14 sept. 2026) | — | **P4** | ajout | carnet du poste (le casier se voit de loin), le stool, l'avocat du Carré, **un hacker dans La Shop** qui efface du casier de façon variable contre paiement, bouclier humain |
