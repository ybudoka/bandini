...
| M14 Meta | ⬜ **en cours** (2 vagues livrées : le compte, la session longue, les parties sur le serveur, le jeu qui se synchronise ; **la 3e — le NIP — est en cours**) | 17 sept. 2026 | **P4** | ajout | [notes](#m14-meta) |
...
tests/  conftest.py harnais_js.py banc.js (bac à sable Node : faux canvas/DOM/fetch/manette/audio,
        ...
        test_bd.py test_comptes.py test_comptes_js.py test_poste_et_garage.py test_poste_et_garage_js.py test_debug_js.py test_accents.py test_passage_pietons.py test_zz_smoke.py
