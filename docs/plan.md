...
| ce qui est **livré** (224 jalons) | [jalons/README.md](jalons/README.md) |
...
| Des bruitages déjà payés là où le jeu n'avait que des oscillateurs | ⬜ **en cours** | 22 sept. 2026 | **P4** | ajout | [fiche](jalons/des-bruitages-deja-payes-la-ou-le-jeu-n-avait-que-des-oscillateurs.md#fiche) |
| Un comptoir reste ouvert après un achat | ⬜ **en cours** | 22 sept. 2026 | **P2** | **correctif** | [fiche](jalons/un-comptoir-reste-ouvert-apres-un-achat.md#fiche) |
