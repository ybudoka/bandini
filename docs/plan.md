...
| Des blocs de carte en extensions | ⬜ **à faire** (tranché : une carte à part, on y passe par un fondu au noir ; reste à trancher ce que le fondu emporte — la police, le temps) | — | **P3** | ajout | [fiche](jalons/des-blocs-de-carte-en-extensions.md#fiche) |
