...
| Les hommes de Sal cognent à mains nues | **en cours** | 16 sept. 2026 | **P2** | ajout | demande de Martin : « les hommes de Sal sont à main nue ou poing américain (un peu plus fort) ». Ils naissent dans le corps d'un **Cravate** (`Entites.archetype('cravate')`), et la fiche du Cravate porte un **bâton** (`arme: "batte"`, 18 de dégâts, renverse) — un recouvrement qui arrive la batte à la main, et qui la laisse tomber quand on le couche. Un **poing américain** entre au catalogue (entre les poings et le bâton), et chaque homme de Sal sort avec l'un ou l'autre. |
