...
| Des meubles d'un seul tenant : table, tapis, machine | **en cours** (14 sept. 2026) | suite des lits, demande de Martin (« regarde si d'autres composantes mériteraient un traitement similaire », puis « oui vas-y »). Même défaut, trois glyphes : le **billard** du bar et de la taverne (table 4 × 2) est huit tabourets, une table sur deux rangées est deux carrés ; le **tapis** met son galon en haut et en bas de chaque tuile, donc un 3 × 3 est trois chemins de couloir ; une **machine** de 4 × 2 est huit petites machines. Le même masque des voisines (`varianteDeBloc`, la fiche dit `bloc`) et les mêmes juges |
...
| La porte s'ouvre pour le joueur aussi | **en cours** (14 sept. 2026) | retour de Martin (« les portes doivent ouvrir quand j'entre aussi ») : le battant s'ouvre pour les piétons et **pas pour le joueur** — il passe au travers d'une porte fermée. ⚠️ Et le jeu est **figé** pendant le fondu de porte, donc un battant ouvert au départ resterait figé au premier pixel : il faut le faire battre pendant la transition |
...
*Demande de Martin.* ⚠️ **Tout le reste du parc est utilitaire** — on le prend parce qu'il
...
- ⚠️ **Ce qui n'est PAS fait, et c'est une décision** : un décor cassé n'est pas
  *enjambable* — il est **traversable**. La fiche voulait de la solidité 3 (comme une
