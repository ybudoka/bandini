...
|---|---|---|---|---|
| **P1** | ajout | M9 Le parc et les boulots | 2 | ⚠️ **Les sprites sont livrés — le catalogue ne ment plus.** ⚠️ **Toutes les fiches sont lues, et le haut de gamme est livré.** Restent les boulots au klaxon, le comptoir de fourrière et la radio du camion. Prérequis de M10 |
