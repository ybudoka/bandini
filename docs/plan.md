...
| Des voix qui ne sonnent plus sourd | **en cours** | 16 sept. 2026 | **P2** | **correctif** | suite du retour « caverneuses ou étouffées » : Martin accepte la correction mesurée — une égalisation par voix (v3 a ajouté +6 à +18 dB entre 100 et 250 Hz à Julia, Amélie et Jeanne Mance, et retiré 5 à 9 dB au-dessus de 3 kHz à Julia et Léo) et les passants en 44 kHz (le 22 kHz / 32 kbit/s coupait tout au-dessus de 8 kHz, alors que les masters montent à 14). Sans rien générer : depuis les masters. |
