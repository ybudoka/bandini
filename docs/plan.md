...
| Deuxième service dure plus longtemps : le stool fait un détour avant le poste | ⬜ **en cours** | 22 sept. 2026 | **P2** | **correctif** | [fiche](jalons/deuxieme-service-dure-plus-longtemps-le-stool-fait-un-detour-avant-le.md#fiche) |
| Le carnet revient sur la même ligne en sortant d'une fiche | ⬜ **en cours** | 22 sept. 2026 | **P2** | **correctif** | [fiche](jalons/le-carnet-revient-sur-la-meme-ligne-en-sortant-d-une-fiche.md#fiche) |
