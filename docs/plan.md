...
| Des variantes pour tout le parc | **en cours** | 16 sept. 2026 | **P2** | ajout | réponse de Martin (« aussi des variantes ») : seule l'auto a des silhouettes. Le camion, l'autobus, la luxe et la chaloupe en reçoivent ; le taxi, la police, l'ambulance et la remorqueuse sont des flottes et le restent. |
