...
| M16 Cent missions | ⬜ **en cours** (la tranche 1 « le moteur » avance : dix missions de plus livrées — `f04`, `f05`, `f06`, `f07`, `f09`, `f11`, `h01`, `p01`, `q03`, `e12` — avec le premier juge de banc joué pour huit des neuf types neufs ; ✅ **les dialogues, les scènes et les voix sont sortis du paquet** — `/api/dialogue/<slug>` avec son ETag, 369 224 → 239 190 octets bruts, le juge est vert ; ⚠️ 903 octets de marge gzip : ⬜ **les `objectifs` sortent du paquet — en cours, 25 sept. 2026** ; restent `eteindre` (pas de feu qu'une mission puisse allumer elle-même), le téléphone qui trie, et le reste de l'arc F) | 18 sept. 2026 | **P4** | ajout | [fiche](jalons/m16-cent-missions.md#fiche) · [notes](jalons/m16-cent-missions.md#notes) |
