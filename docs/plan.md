...
| De vraies plages, pas des bouts de sable | **en cours** | 16 sept. 2026 | **P2** | **correctif** | retour de Martin : « moins de plage autour, et des accessoires de plage et des gens s'il y a beaucoup de place, pas juste des petits morceaux de plage ». ⚠️ **Mesuré** (graine livrée) : **1 754 tuiles de sable en 65 morceaux**, dont **41 de moins de dix tuiles** — `_eau()` borde CHAQUE côté de chaque bassin d'une bande de 0 à 4 tuiles qui avance et recule, jusque dans les chenaux ; et les **104 meubles de plage** tombent tous sur ces bandes étroites. Le plan : peu de plages, mais larges (profondes, face au large, jamais dans un chenal) ; le reste de la côte touche l'eau sans sable ; parasols, serviettes et baigneurs **seulement** sur une plage qui a la place. |
| Se réveiller dans un lit d’hôpital | **en cours** | 16 sept. 2026 | **P2** | ajout | demande de Martin : « pour le réveil à l'hôpital, je veux qu'on se réveille à l'intérieur et dans un lit, couché, dès le premier déplacement on se lève et on peut partir ». Aujourd'hui on se réveille **dehors**, sur le trottoir devant la porte. |
