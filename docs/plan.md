...
| Des blocs de carte en extensions | ⬜ **à faire** (à trancher par Martin : toujours là, allumés par partie, ou débloqués en jouant) | — | **P3** | ajout | [fiche](jalons/des-blocs-de-carte-en-extensions.md#fiche) |
...
| **P3** | ajout | Des blocs de carte en extensions | 3 | ⚠️ **porte** la deuxième planque, la cabane à sucre, le centre d'achat hanté et le ciné-parc (chacun « posé en dernier, sans dé ») ; l'île et l'aéroport sont déjà deux blocs faits à la main, à déménager d'abord |
