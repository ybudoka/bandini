...
| Des klaxons qu'on entend de là où ils sont | **en cours** | 16 sept. 2026 | **P2** | **correctif** | retour de Martin : « réduit un peu les klaxon des voiture qui passe ». ⚠️ **Mesuré** : au bord d'une rue du centre, 1 à 6 klaxons du trafic par minute, dont les deux tiers viennent d'un char **hors de l'écran** — et tous partent au **plein volume** (`avertir`, `vehicules.js`), la règle des coups des autres ne les touchait pas. |
