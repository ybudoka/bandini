...
| L'avocat qu'on voit au Brouillard | **en cours** | 16 sept. 2026 | **P2** | **correctif** | demande de Martin : « je ne vois pas d'image de l'avocat dans le bar, il faut en faire une ». Le jeu promet un avocat (« PARLER A L'AVOCAT », Me Desjardins à la table du fond) et la table est **vide** : le point `avocat` n'est qu'un comptoir invisible, exactement le défaut réparé pour Bouchard et Josée. Ce qu'on fait : **un corps à lui** (complet, chemise blanche, cravate rouge, cheveux gris — sur le corps commun, un complet foncé serait une Cravate), **assis** sur la chaise de sa table comme le patient de l'hôpital ; ACTION à côté de lui ouvre toujours son menu. |
