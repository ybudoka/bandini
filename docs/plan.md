...
| Des chars arrondis | **en cours** | 16 sept. 2026 | **P2** | **correctif** | demande de Martin : « arrondit un peu (léger) les véhicules ». La berline en volume est une boîte à angles vifs, de profil comme vue d'en haut ; les chars encore dessinés à la main ont déjà le nez et la queue pincés. |
