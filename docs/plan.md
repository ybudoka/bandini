...
| M2 | Piétons et poings | apparition, flâner/fuir/témoin, mêlée, coup fort, esquive, 4 armes (bâton, couteau, pistolet, fusil), projectiles, ramassage, armes improvisées, sang, pickpocket, HUD arme | bagarre dans la rue ; tests cercle-tuiles, singe |
| M3 | Véhicules | auto, taxi, moto, auto-patrouille ; physique, collisions, monter/descendre/éjecter, trafic + feux, dégâts/explosion, alarmes, rampes, taxi avec pouce lisse, son moteur, projeter dans le trafic | voler, conduire, planter ; tests trafic 3000 images sans blocage, vMax, dérive |
