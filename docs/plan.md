...
| Le budget de démarrage relevé à 2,5 Mo | **en cours** | 16 sept. 2026 | **P3** | ajout | demande de Martin : « augmente la limite ». Les voix de la rue passées en 44 kHz avaient mangé 200 Ko : bruitages et passants à **1,41 Mo sur 1,5**, 94 Ko de marge — le prochain bruitage débordait. |
...
| Rien devant une porte | **en cours** | 16 sept. 2026 | **P2** | **correctif** | retour de Martin, capture à l'appui (une machine distributrice plantée devant la porte de la PIZZERIA NAPOLI) : « jamais rien devant la porte d'une maison, d'un commerce ou autre ». ⚠️ **Mesuré** sur sept graines : les vraies portes (`D`, `d`, `G`) ont toujours leurs deux tuiles de devant libres ; **tout** ce qui bouche est devant une porte **peinte** (`P`, celle qu'une devanture ou un logement se dessine quand son bâtiment n'en a pas tiré) — des distributrices surtout (3 à 6 par ville : `distributrices()` prend le `P` pour une vitrine), et un BBQ, un arbre ou un paquet par-ci par-là. |
