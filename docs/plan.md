...
| Le poing américain chez Gus | ⬜ **en cours** | 17 sept. 2026 | **P4** | ajout | demande de Martin : « on devrait aussi pouvoir l'acheter ». Aujourd'hui il ne se vend nulle part (`armes.py`, prix 0) : on ne l'a qu'en le ramassant sur un homme de Sal couché. |
