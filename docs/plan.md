...
| Des lits qui ont l'air de lits | **en cours** (13 sept. 2026) | demande de Martin (« les lits existants doivent vraiment avoir l'air de lits, juste un set d'oreillers et des couvertes ; actuellement c'est 2 ou 4 cases avec chacune leur oreiller »). ⚠️ Le peintre du lit ne sait pas qu'il a des voisines : chaque tuile `l` dessine son oreiller et sa couverture, donc un lit de 2 × 2 est quatre lits d'une place collés. Le lit lira ses voisines comme la clôture et le toit (`varianteDeLit`) : un seul oreiller en tête, une seule couverte jusqu'au pied, la tête et le cadre seulement là où le lit s'arrête |
| Le décor se brise | **P2** **correctif**, **en cours** (13 sept. 2026) | demande de Martin (poteaux, bancs, arbres, tout ce qui se brise). ⚠️ Aujourd'hui les chars **traversent** tout le décor sans ralentir, et le lampadaire est fantôme même à pied. Deux familles par la fiche — ce qui arrête, ce qui casse — des débris, un poteau à terre qui s'éteint, et la ville qui se souvient jusqu'au lendemain |
