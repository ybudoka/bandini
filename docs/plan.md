...
| Des autos qui ne sont pas toutes la même | **en cours** | 16 sept. 2026 | **P2** | ajout | demande de Martin : « je veux aussi avoir parfois des différences structurelles, pas juste la couleur ». Toutes les autos de la ville sont la même berline repeinte ; le taxi et la police, eux, sont une flotte et le restent. |
