...
| M11 La police apprend | **en cours** (2e vague) | 14 sept. 2026 | **P4** | ajout | ⚠️ **le casier PÈSE dans la rue** : il allonge la portée du cône des agents et des autos-patrouille (+4 % la page, **plafonné à +50 %** — sans ce plafond, vingt pages feraient voir la police à seize tuiles en pleine nuit et il n'y aurait plus une ruelle où souffler). ⚠️ **Pour le joueur seulement** : un casier épais n'aide pas la police à voir les passants — c'est un signalement, pas une paire de jumelles. Et le carnet du poste le **dit** (« ON TE RECONNAÎT : +X % DE LOIN ») : une règle qu'on subit sans jamais la lire n'est pas une règle, c'est une malchance. **2e vague en cours** : effacer le casier — l'avocat (la certitude) et le hacker (le pari), qui ne se conçoivent qu'ensemble. ⚠️ **Géographie tranchée (carte blanche de Martin)** : il ne faut qu'**un seul lieu neuf**, pas deux — la table des personnages place déjà `desjardins` « Bar Le Brouillard, table du fond », et un avocat qui tient salon à la table du fond d'une taverne est plus juste qu'une étude à lui. Le hacker, lui, prend un lieu neuf à **La Shop** (glyphe `E`) : c'est le trajet qui fait le risque. **Restent en 3e vague** : le stool, le bouclier humain. 2 juges neufs |
