...
| Le vélo et son cycliste | **en cours** | 16 sept. 2026 | **P2** | **correctif** | retour de Martin, capture à l'appui : « il faut améliorer ça ». ⚠️ **Mesuré** : la machine qui tourne est le **toit** d'un deux-roues — vu d'en haut, un vélo est un bâton avec une barre en travers — et le cycliste posé dessus est **de profil**, assis comme sur une chaise, les pieds dans le vide : on lit un passant sur une échasse. |
