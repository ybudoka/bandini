...
| Un dictionnaire de prononciation pour les voix | ⬜ **en cours** (livrés : le lexique de 15 règles, le serveur MCP, le script, le juge ; reste : la permission `pronunciation_dictionaries_write` sur la clé ElevenLabs — Martin —, puis le premier téléversement et les 13 voix à refaire si Martin le veut) | 22 sept. 2026 | **P4** | ajout | [fiche](jalons/un-dictionnaire-de-prononciation-pour-les-voix.md#fiche) · [notes](jalons/un-dictionnaire-de-prononciation-pour-les-voix.md#notes) |
