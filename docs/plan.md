...
| Des voix qui jouent, et qui finissent leurs phrases | **en cours** | 16 sept. 2026 | **P2** | **correctif** | demande de Martin : « je veux que tu regénères toutes les voix en mettant des pauses dans le texte et de l'émotion, et un léger temps mort à la fin pour éviter les fins coupées ». ⚠️ **Mesuré avant** : les 19 répliques du narrateur (ouverture, journal) finissent avec **10 à 47 ms** de silence et du son encore audible dans les 120 dernières ms — ce sont elles qui se coupent ; les 64 autres gardent 150 à 450 ms. Les 83 répliques sont refaites. |
