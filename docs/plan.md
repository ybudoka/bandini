...
| Des blocs de carte en extensions | ⬜ **en cours** (✅ vague 1 livrée : à pied, la clairière du lac au nord des Érables ; restent le char et la coop, un vrai dehors, le premier vrai bloc) | 25 sept. 2026 | **P3** | ajout | [fiche](jalons/des-blocs-de-carte-en-extensions.md#fiche) |
