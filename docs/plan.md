...
| Des voix sans réverbération | **en cours** | 16 sept. 2026 | **P2** | **correctif** | retour de Martin après écoute : « les voix sonnent un peu caverneuses ou étouffées », puis « regénère Mme Thibodeau et les prostituées et toutes les voix avec réverbération, je les veux sans réverbération ». ⚠️ **Mesuré avant** (spectres v2 / master v3 / fichier fini) : la finition ne change rien au timbre ; c'est **v3** qui rend Julia (Thibodeau, la Brume, La Brume radio) plus sourde (centroïde 525 → 287 Hz) et qui allonge la queue d'Amélie et de Léo (×2 à ×4). |
...
| Les chars en volume | **en cours** (la berline d'abord) | 16 sept. 2026 | **P2** | **correctif** | demande de Martin, après le vélo : « je veux que tu fasses une belle job comme ça avec les voitures, commence par une et je te donne le go pour la suite ». Le char qui roule est son **toit** (la pose `haut`, une vue plongeante de dos) tourné en 32 caps : vers l'est, on voit un toit couché sur le flanc, pas une auto de profil. La berline d'abord, décrite en volume et projetée au cap comme le vélo ; taxi, police et le reste du parc attendent le go. |
