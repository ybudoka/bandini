...
| Des blocs de carte en extensions | ⬜ **à faire** (tout est tranché : une carte à part derrière un fondu au noir, la police reprend au bord, l'heure continue ; quatre vagues) | — | **P3** | ajout | [fiche](jalons/des-blocs-de-carte-en-extensions.md#fiche) |
