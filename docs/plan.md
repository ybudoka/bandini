...
| Le métro | **en cours** | 16 sept. 2026 | **P4** | ajout | demande de Martin : « je veux aussi un métro », puis, au choix : **souterrain**, comme à Montréal. Un édicule « M » sur le trottoir, on descend sur un vrai quai, la rame arrive et ouvre ses portes, on monte, le tunnel défile, et on remonte à une autre station — y compris sous la baie, jusqu'à La Pointe, là où les autobus ne vont pas. |
...
app/  __init__.py routes.py version.py scores.py definitions.py
      ...
      chantiers.py autobus.py mobilier.py
...
tests/  conftest.py harnais_js.py banc.js (bac à sable Node : faux canvas/DOM/fetch/manette/audio,
        ...
        test_icones.py test_autobus.py test_autobus_js.py test_mobilier.py
