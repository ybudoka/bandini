...
| ce qui est **livré** (215 jalons) | [jalons/README.md](jalons/README.md) |
...
| M14 Meta | ⬜ **en cours** (6 vagues livrées : le compte, la session longue, les parties sur le serveur, le jeu qui se synchronise, le NIP, effacer son compte, le défi du jour, et le mode photo ; la coop locale a son essai (un clavier, une manette), **en remaniement** : deux VRAIS joueurs, chacun sur sa source d'entrées — ça corrige ses coups qui ne portent pas, les portes et la voiture, et ça laisse la porte ouverte à une coop en ligne) | 17 sept. 2026 | **P4** | ajout | [fiche](jalons/m14-meta.md#fiche) · [notes](jalons/m14-meta.md#notes) |
