...
| Des chars qui montrent leur longueur | **en cours** | 16 sept. 2026 | **P2** | **correctif** | réponse de Martin (« oui plus long ») : de dos et de face, la berline en volume occupe 21 rangées pour 28 px de long — le sol se voit du biais de l'ombre (0,5), là où l'ancien toit tourné en montrait 28. |
