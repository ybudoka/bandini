...
| Le logo dans l'ouverture | **en cours** | 16 sept. 2026 | **P2** | **correctif** | retour de Martin : « les nouveau logo d'intro n'a pas été placé après l'animation d'intro ». Le logo n'était que sur l'accueil (le `<h1>`) : le titre qui monte quand le car repart s'écrit encore « BANDINI » en police du HUD (`Hud.dessinerOuverture`). |
