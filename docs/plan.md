...
| ce qui est **livré** (201 jalons) | [jalons/README.md](jalons/README.md) |
...
| Les courses : suivre les flèches, un tour par quartier | ⬜ **en cours** | 21 sept. 2026 | **P4** | ajout | [fiche](jalons/les-courses-suivre-les-fleches.md#fiche) |
| M14 Meta | ⬜ **en cours** (6 vagues livrées : le compte, la session longue, les parties sur le serveur, le jeu qui se synchronise, le NIP, effacer son compte, le défi du jour, et le mode photo ; reste la coop) | 17 sept. 2026 | **P4** | ajout | [fiche](jalons/m14-meta.md#fiche) · [notes](jalons/m14-meta.md#notes) |
