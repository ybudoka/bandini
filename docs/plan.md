...
| La roue d'armes | **en cours** | 16 sept. 2026 | **P2** | ajout | demande de Martin : « je veux un meilleur sélecteur d'arme ». ⚠️ **Mesuré** : le catalogue compte **13 armes** et `cycler` n'avance que d'**un cran, dans un seul sens** — revenir de la carabine aux poings coûte **12 pressions**, en pleine fusillade. Le HUD ne montre que l'arme en main : on cycle **à l'aveugle**, sans savoir ce qui vient. Et le cycle ne filtre que sur la **possession**, jamais sur les munitions — on dégaine un pistolet à zéro et on perd le tour. Une **roue** : on TIENT ARME, les armes possédées s'ouvrent en cercle (les icônes `OBJETS` 16×10 sont déjà dessinées), on choisit au stick / aux flèches / au pouce, on relâche pour dégainer ; munitions sous chaque icône, grisée à vide. ⚠️ Le monde **ralentit à 0,25×**, il ne gèle pas — les menus figent (`ouvrirMenu`), mais une roue qui fige est une **pause gratuite** au milieu d'une fusillade : changer d'arme doit coûter quelque chose, comme la clôture où l'on ne peut rien faire. Une **tape courte** ne l'ouvre pas : elle bascule entre les **deux dernières** armes (les poings pour les poches, la carabine pour le toit) — c'est le geste qu'on fait le plus souvent, et il ne doit rien coûter. |
