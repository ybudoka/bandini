...
PALIERS: dict[str, tuple[dict, ...]] = {
    "taxi": (
        {"compte": 10, "type": "prime", "valeur": 1.3,
         "nom": "ON TE RECONNAÎT", "detail": "+30 % DE POURBOIRE"},
        {"compte": 25, "type": "rabais", "valeur": 0.75, "cle": "kiosque",
         "nom": "LE CAFÉ DU CHAUFFEUR", "detail": "-25 % AUX KIOSQUES"},
        {"compte": 50, "type": "char", "valeur": "taxi",
         "nom": "TON PROPRE TAXI", "detail": "GARÉ À LA PLANQUE"},
    ),
    "pizza": (
        {"compte": 10, "type": "prime", "valeur": 1.3,
         "nom": "LIVREUR DU MOIS", "detail": "+30 % DE PRIME"},
        {"compte": 25, "type": "hopital", "valeur": 0.5,
         "nom": "TU CONNAIS TOUT LE MONDE", "detail": "HÔPITAL À MOITIÉ PRIX"},
        {"compte": 50, "type": "char", "valeur": "moto",
         "nom": "LA MOTO DU LIVREUR", "detail": "GARÉE À LA PLANQUE"},
    ),
    "ambulance": (
        {"compte": 10, "type": "vie", "valeur": 1.10,
         "nom": "TU AS VU PIRE", "detail": "+10 % DE VIE"},
        {"compte": 25, "type": "vie", "valeur": 1.25,
         "nom": "PLUS RIEN NE T'ÉCOEURE", "detail": "+25 % DE VIE"},
        {"compte": 50, "type": "char", "valeur": "ambulance",
         "nom": "L'AMBULANCE EST À TOI", "detail": "GARÉE À LA PLANQUE"},
    ),
    "remorquage": (
        {"compte": 10, "type": "fourriere", "valeur": 0.5,
         "nom": "LES GARS DU LOT TE CONNAISSENT", "detail": "RACHAT À MOITIÉ PRIX"},
