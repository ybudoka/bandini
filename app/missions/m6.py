    ...
    "dialogue": {
        ...
        "accueil": [
            _a("tipaul", "Ah, c'est toi, le nouveau de Josée! Ici, rien passe sans que je le sache.", 0,
               jeu="[cheerful] Ah, c'est toi, le nouveau de Josée! [knowingly] Ici, rien passe… sans que je le sache."),
            _a("lulu", "Josée m'a parlé de toi. Assis-toi, mange un peu, t'as l'air d'un fantôme.", 1,
               jeu="[warmly] Josée m'a parlé de toi. [teasing] Assis-toi, mange un peu… t'as l'air d'un fantôme."),
            _a("raymonde", "Le syndicat, c'est moi. Josée se porte garante de toi, ça reste à voir.", 2,
               jeu="[firmly] Le syndicat, c'est moi. Josée se porte garante de toi… ça reste à voir."),
            _a("ovila", "Les lumières du port, c'est moi. Depuis ici, je vois tout ce qui entre.", 3,
               jeu="[calm] Les lumières du port, c'est moi… Depuis ici, je vois tout ce qui entre."),
        ],
    },
}
