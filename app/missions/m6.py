...
MISSION = {
    ...
    "dialogue": {
        ...
        "fin": [
            _l("josee", "C'est Josée. Quatre poignées de main. Le monde va t'appeler par ton nom, astheure.",
               jeu="[satisfied] C'est Josée. Quatre poignées de main. [warmly] Le monde va t'appeler par ton nom… astheure."),
        ...
        "echec": [_l("josee", "Josée. Tu reviendras quand tu auras le temps de faire le tour.",
                     jeu="[disappointed] Josée. Tu reviendras… quand tu auras le temps de faire le tour.")],
        ...
        "accueil": [
            ...
            _a("lulu", "Allô, mon grand! Moi, c'est Lulu, la sœur de Josée. Assis-toi, mange, t'as l'air d'un fantôme.", 1,
               jeu="[warmly] Allô, mon grand! Moi, c'est Lulu, la sœur de Josée. [teasing] Assis-toi, mange… t'as l'air d'un fantôme."),
            _a("raymonde", "Raymonde Fortin, présidente du syndicat. Josée se porte garante de toi, ça reste à voir.", 2,
               jeu="[firmly] Raymonde Fortin, présidente du syndicat. Josée se porte garante de toi… ça reste à voir."),
            _a("ovila", "Ovila Saint-Onge, pour vous servir. Les lumières du port, c'est moi. D'ici, je vois tout ce qui entre.", 3,
