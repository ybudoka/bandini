#!/usr/bin/env bash
# Deploiement d'Bandini sur le serveur de gestiondojo.ca.
#
#   ssh dojoadmin@103.98.215.181
#   bash /srv/bandini/repo/deploy/deploy.sh [branche]
#
# ⚠️ A lancer en tant que **dojoadmin**, PAS `www-data` — meme raison que pour
# le site de jeux : `/srv/bandini/releases` appartient a dojoadmin et le
